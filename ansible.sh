...
ansible-playbook -i ${component}-${env}.azcart.online, -e ansible_user=ec2-user -e ansible_password=DevOps321 -e env=${env} -e component=${component} -e role_name=${component} rolecall.yaml
